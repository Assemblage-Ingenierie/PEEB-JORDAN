import { SlidersHorizontal, RefreshCw, Info, Target, TrendingUp, TrendingDown } from 'lucide-react';
import { useApp } from '../../context/AppContext';
import { MEASURE_META, MEASURE_KEYS, DEFAULT_SCORE_CONFIG, SCORE_INDICATORS } from '../../engine/CalculationEngine';
...
export default function Parameters() {
  const { params, setParam, setUnitCost, setScoreCriterion, notify } = useApp();
    ...
    <div className="space-y-6 fade-in" style={{ maxWidth: '760px' }}>
      ...
      <div className="card">
        ...
        <p className="text-xs mb-4" style={{ color: 'var(--ai-noir70)' }}>
          Installed cost per m² of floor area. Can be overridden at the individual building level.
        </p>
